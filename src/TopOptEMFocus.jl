...
function rrule(::typeof(gf_pf), pf_vec; β, η, phys_params, fem_params)
    function pullback(Δg)
        ZeroTangent(), Δg * Dgfdpf(pf_vec; β, η, phys_params, fem_params)
    end
    gf_pf(pf_vec; β, η, phys_params, fem_params), pullback
end
...
function rrule(::typeof(pf_p0), p0; r, fem_params)
    function pullback(Δpf)
        ZeroTangent(), Dpfdp0(Δpf; r, fem_params)
    end
    pf_p0(p0; r, fem_params), pullback
end

function Dpfdp0(Δpf; r, fem_params)
