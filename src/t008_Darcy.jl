...
model = CartesianDiscreteModel(domain=(0.0,1.0,0.0,1.0), partition=(6,6))
...
# res(u) = a(u,u)
# e1l2 = sqrt(sum( integrate(res(xh),trian,quad) ))

# e1l2 = sqrt(sum( integrate(g(xh),btrian,bquad) ))
...
writevtk(trian,"/home/santiago/github-repos/Gridap/tmp/darcyresults",cellfields=["uh"=>xh[1],"ph"=>xh[2]])
##
end # module
